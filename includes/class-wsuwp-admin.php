	...
	public function all_plugins( $plugins ) {
		...
		$plugin_access_list = array(
			...
			'cahnrswsuwp-plugin-pagebuilder/plugin.php' => array(
				...
				'environment.wsu.edu/',
				'plantpath.wsu.edu/',
				'stage.web.wsu.edu/lindstation/',
				'stage.web.wsu.edu/soilwater/',
				'stage.web.wsu.edu/soilfungus/',
				'stage.web.wsu.edu/sweetcherrybreeding/',
				'stage.web.wsu.edu/sustainability/',
				'stage.web.wsu.edu/waruralprosperity/',
				'stage.web.wsu.edu/foodsystems/',
				'stage.web.wsu.edu/jointedgoatgrass/',
				'stage.web.wsu.edu/cultivatingsuccess/',
				'stage.web.wsu.edu/waae/',
				'stage.web.wsu.edu/pep/',
				'stage.web.wsu.edu/hd/',
			),
