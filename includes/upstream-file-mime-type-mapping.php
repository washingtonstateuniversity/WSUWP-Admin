 ...
 *
 * This function was sourced from GPL licensed Drupal 7.x:
 * https://api.drupal.org/api/drupal/includes%21file.mimetypes.inc/function/file_default_mimetype_mapping/7.x
 *
 * The function has been renamed to help avoid collisions.
 *
 * @return
 ...
 */
function wsuwp_file_default_mimetype_mapping() {
	return array(
		'mimetypes' => array(
